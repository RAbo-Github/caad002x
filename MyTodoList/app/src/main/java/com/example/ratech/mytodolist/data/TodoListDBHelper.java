...
public class TodoListDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_TODO_TABLE = "CREATE TABLE "
                ...
                + TodoListContract.TodoEntry._ID
                + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + TodoListContract.TodoEntry.COLUMN_DATETEXT
                + " INTEGER, "
                + TodoListContract.TodoEntry.COLUMN_DESC
                + " TEXT NOT NULL, "
                + TodoListContract.TodoEntry.COLUMN_DUE_DATE_TEXT
                + " INTEGER, "
                + TodoListContract.TodoEntry.COLUMN_DONE
                + " INTEGER, "
                + "UNIQUE (" + TodoListContract.TodoEntry.COLUMN_DESC
                + ", "
                + TodoListContract.TodoEntry.COLUMN_DATETEXT
                + ") ON "
                + "CONFLICT IGNORE"
