...
public class MainActivity extends AppCompatActivity {
    ...
    private class DownloadPokemonTask extends AsyncTask<Void, Integer, ArrayList<String>> {
        ...
        // Remember that in onPreExecute() we are in the Main Thread
        @Override
        ...
        protected ArrayList<String> doInBackground(Void... params) {
            ...
            for (int i = 1; i <= 3; i++) {
                try {
                    Thread.sleep(1000); // we suppose that the call lasts 1 s
                    newPokemonList.add(simulateCalltoAPI(i)); // simulation
